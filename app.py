...
athletes = {
    ...
    "Titia": {"avocat", "quinoa", "boulgour", "pois chiches", "noix", "noix de cajou"},
    "Laura": {""},
    "Maaike": {"émincés de poulet", "jambon blanc", "jambon cru", "dés de jambon", "fruits de mer"},
    "Lotte": {"thon", "carottes râpées", "salade", "sauce au yaourt", "dés de fromage", "poivrons", "radis", "sauce soja"},
    "Valentina": {"oeufs brouillés", "mayonnaise"},
    "Michaela": {"fruits de mer", "saumon", "saumon fumé"},
    "Danielle": {"pâtes", "gnocchis", "semoule", "boulgour"},
    "Emilia": {"pâtes", "gnocchis", "semoule", "boulgour", "radis", "dés de jambon", "tofu"},
    "Marjolein": {""},
    "Clémence": {"mayonnaise"},
...
recettes = {
    ...
    "Pâtes au saumon": {"pâtes", "saumon fumé", "fromage blanc"},
    "Salade riz-saumon": {"riz", "saumon", "sauce au yaourt", "concombre", "carottes râpées"},
    ...
    "Salade méditerranéenne": {"riz", "lentilles", "concombre", "feta", "tomates cerises"},
    "Salade italienne": {"gnocchis", "jambon cru", "mozzarella", "tomates cerises"},
    "Salade niçoise": {"riz", "thon", "oeufs durs", "tomates cerises", "haricots verts"},
